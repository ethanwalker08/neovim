...
description: 'Audit one workflow slice by comparing nvim.bak with the current LazyVim config. Use for finding behavior mismatches, muscle-memory risks, and missing aliases or adaptations.'
argument-hint: 'Describe the single workflow slice, behavior, or file area to audit.'
user-invocable: true
---
