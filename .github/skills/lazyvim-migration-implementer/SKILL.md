...
description: 'Implement one LazyVim migration step. Use for scoped code changes that preserve muscle memory, follow LazyVim file placement rules, update migration docs, and validate the touched behavior.'
argument-hint: 'Describe the migration step set to implement and the workflow to preserve.'
user-invocable: true
---
...
- One workflow step or a coherent related step set needs to be implemented.
...
6. Update `docs/migration_log.md` and `docs/workflow_acceptance.md` when finished.
