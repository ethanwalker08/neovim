...
description: "Use when migrating this Neovim config from nvim.bak to LazyVim, preserving workflows, auditing migration steps, implementing the requested work, updating migration docs, and validating regressions. Keywords: LazyVim migration, nvim.bak, workflow preservation, migration steps, keymaps, terminal workflows, git workflows, search workflows, LSP workflows, completion workflows, UI workflows."
